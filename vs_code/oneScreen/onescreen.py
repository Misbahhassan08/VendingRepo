...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboBox.addItem("")
        self.set_screen_btn = QtWidgets.QPushButton(self.tool_bar)
        self.set_screen_btn.setGeometry(QtCore.QRect(10, 40, 245, 34))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.set_screen_btn.sizePolicy().hasHeightForWidth())
        self.set_screen_btn.setSizePolicy(sizePolicy)
        self.set_screen_btn.setMinimumSize(QtCore.QSize(245, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.set_screen_btn.setFont(font)
        self.set_screen_btn.setStyleSheet("background-color:white")
        self.set_screen_btn.setObjectName("set_screen_btn")
        self.close_button = QtWidgets.QPushButton(self.tool_bar)
        self.close_button.setGeometry(QtCore.QRect(10, 950, 245, 34))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.set_screen_btn.setText(_translate("MainWindow", "Set Screens"))
